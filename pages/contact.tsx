export default function Contact() {
  return (
    <>
      ...
      <p>Here are a couple of reasons to contact me.</p>
      <ol>
      ...
      <p>I'd like to hear from you, so please email me at <a href="mailto:dlo@davidlopez.dev">dlo@davidlopez.dev</a>.</p>
    </>
  )
}