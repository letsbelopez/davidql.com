  ...
  return (
    <Layout home>
      ...
      <div className="max-w-prose text-xl space-y-7">
        <p>Welcome to my hand built personal website. <Link href="/posts/site"><a className="text-blue-600 hover:text-blue-800 duration-200">Read</a></Link> about how I made it.</p>
      ...
      <h2 className="text-3xl mt-14 mb-7 font-medium">Latest Posts</h2>
      <ul className="max-w-prose text-xl">
        <li>
          <Link href="/posts/better-friend"><a className="text-blue-600 hover:text-blue-800 duration-200">Be a better friend</a></Link>
        </li>
        <li>
          <Link href="/posts/xstate"><a className="text-blue-600 hover:text-blue-800 duration-200">XState - Introductory Course to State Machines</a></Link>
        </li>
      </ul>
      <h2 className="text-3xl mt-14 mb-7 font-medium">Recent Work Projects</h2>
      <ul className="max-w-prose text-xl">
        <li>
          <Link href="/posts/synctup"><a className="text-blue-600 hover:text-blue-800 duration-200">SynctUp - Cross Platform Mobile App</a></Link>
        </li>
        <li>
          <Link href="/posts/ikonix"><a className="text-blue-600 hover:text-blue-800 duration-200">Ikonix USA - Enterprise Single Page App</a></Link>
        </li>
      </ul>
    </Layout>
  )
